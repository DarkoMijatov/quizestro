...
export const InviteEmail = ({
  ...
  <Html lang="sr" dir="ltr">
    <Head />
    <Preview>Pozvani ste na {siteName || SITE_NAME}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Pozvani ste da se pridružite platformi{' '}
          <Link href={siteUrl} style={link}>
            <strong>{siteName || SITE_NAME}</strong>
          </Link>. Kliknite na dugme ispod da prihvatite pozivnicu i kreirate nalog.
        </Text>
        <Button style={button} href={confirmationUrl}>
          Prihvati pozivnicu
        </Button>
        <Text style={hint}>
          Ako niste očekivali ovu pozivnicu, možete slobodno ignorisati ovaj email.
        </Text>
        <Hr style={hr} />
